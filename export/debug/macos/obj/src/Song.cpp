...
HX_DEFINE_STACK_FRAME(_hx_pos_4e288e2989890fc6_24_new,"Song","new",0xfb6c8f67,"Song.new","Song.hx",24,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_46_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",46,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_75_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",75,0x775e99e9)

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,int bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_24_new)
HXLINE(  33)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  32)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  30)		this->speed = ((Float)1);
HXLINE(  29)		this->needsVoices = true;
HXLINE(  37)		this->song = song;
HXLINE(  38)		this->notes = notes;
HXLINE(  39)		if (( (bool)(::ModifierVariables_obj::_modifiers->__Field(HX_("VibeSwitch",6a,9e,5d,65),::hx::paccDynamic)) )) {
HXLINE(  40)			this->bpm = (( (Float)(bpm) ) * ( (Float)(::ModifierVariables_obj::_modifiers->__Field(HX_("Vibe",d6,5b,28,39),::hx::paccDynamic)) ));
            		}
            		else {
HXLINE(  42)			this->bpm = ( (Float)(bpm) );
            		}
            	}
...
bool Song_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_46_loadFromJson)
HXLINE(  47)		::String key = (folder.toLowerCase() + HX_("/",2f,00,00,00));
HXDLIN(  47)		::String library = null();
HXDLIN(  47)		::String rawJson = ::StringTools_obj::trim(::lime::utils::Assets_obj::getText(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + (key + jsonInput.toLowerCase())) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE(  49)		while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE(  51)			rawJson = rawJson.substr(0,(rawJson.length - 1));
            		}
HXLINE(  71)		return ::Song_obj::parseJSONshit(rawJson);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_75_parseJSONshit)
HXLINE(  76)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE(  77)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE(  78)		return swagShit;
            	}
...
::hx::ObjectPtr< Song_obj > Song_obj::__new(::String song,::Array< ::Dynamic> notes,int bpm) {
	::hx::ObjectPtr< Song_obj > __this = new Song_obj();
	__this->__construct(song,notes,bpm);
	return __this;
}

::hx::ObjectPtr< Song_obj > Song_obj::__alloc(::hx::Ctx *_hx_ctx,::String song,::Array< ::Dynamic> notes,int bpm) {
