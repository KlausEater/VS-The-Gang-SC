...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Funkin MU",d7,6d,5a,36),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Verwex",47,96,de,d5));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Funkin MU",d7,6d,5a,36));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Mic'd Up",ea,cf,09,50));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.verwex.funkMU",2e,7c,6c,3a));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("MU 2.0.2",80,b3,cd,b6));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Mic'd Up",ea,cf,09,50))
