...
HX_LOCAL_STACK_FRAME(_hx_pos_d3f7691e8659205f_112_setParameter,"haxe.http.HttpBase","setParameter",0x7f4fc53e,"haxe.http.HttpBase.setParameter","/usr/local/lib/haxe/std/haxe/http/HttpBase.hx",112,0x0b31f0aa)
...
void HttpBase_obj::setParameter(::String name,::String value){
            	HX_STACKFRAME(&_hx_pos_d3f7691e8659205f_112_setParameter)
HXLINE( 113)		{
HXLINE( 113)			int _g = 0;
