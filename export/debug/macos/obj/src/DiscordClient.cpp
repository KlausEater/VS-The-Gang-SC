...
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_33_onReady,"DiscordClient","onReady",0x690ae04d,"DiscordClient.onReady","Discord.hx",33,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_43_onError,"DiscordClient","onError",0xf57a0bb2,"DiscordClient.onError","Discord.hx",43,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_48_onDisconnected,"DiscordClient","onDisconnected",0xa84d7d11,"DiscordClient.onDisconnected","Discord.hx",48,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_55_initialize,"DiscordClient","initialize",0x1dd16b67,"DiscordClient.initialize","Discord.hx",55,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_52_initialize,"DiscordClient","initialize",0x1dd16b67,"DiscordClient.initialize","Discord.hx",52,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_62_shutdown,"DiscordClient","shutdown",0x0f46b2ed,"DiscordClient.shutdown","Discord.hx",62,0xa6c9e0b2)
...
HXLINE(  13)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("822967001903005716",b4,d6,39,f7))
...
void DiscordClient_obj::onReady(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_33_onReady)
HXDLIN(  33)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("state",11,76,0b,84),null())
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("Booting up",ab,14,33,44))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),HX_("iconpresence",b4,da,63,38))
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("FNF: Mic'd Up",bb,9d,74,d5))));
            	}
...
void DiscordClient_obj::onError(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_43_onError)
HXDLIN(  43)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),43,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
void DiscordClient_obj::onDisconnected(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_48_onDisconnected)
HXDLIN(  48)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),48,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
void DiscordClient_obj::initialize(){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_e5abf8620039da0e_55_initialize)
HXLINE(  55)			 ::DiscordClient_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_52_initialize)
HXLINE(  53)		 ::Dynamic this1 =  ::__hxcpp_thread_create( ::Dynamic(new _hx_Closure_0()));
HXDLIN(  53)		 ::Dynamic DiscordDaemon = this1;
HXLINE(  57)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),57,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
            	}
...
void DiscordClient_obj::shutdown(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_62_shutdown)
HXDLIN(  62)		::discord_rpc::DiscordRpc_obj::shutdown();
            	}
...
HXLINE(  74)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
            			...
            			->setFixed(3,HX_("largeImageKey",df,8f,e3,ae),HX_("iconpresence",b4,da,63,38))
            			...
            			->setFixed(6,HX_("largeImageText",6d,3e,2d,5e),HX_("FNF: Mic'd Up",bb,9d,74,d5))));
            	}
