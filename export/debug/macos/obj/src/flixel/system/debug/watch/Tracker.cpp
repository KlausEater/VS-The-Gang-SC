...
HXLINE( 163)			{
HXLINE( 163)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile20 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::input::touch::FlxTouch >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_33,7),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxPoint >()));
...
HXLINE( 182)			{
HXLINE( 182)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile24 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,::hx::ClassOf< ::openfl::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,::hx::ClassOf< ::flixel::math::FlxPoint >()));
