...
HXDLIN( 125)				::String _hx_tmp1 = (HX_("liveFile = ",db,e2,06,d5) + ::Std_obj::string(liveFile));
HXDLIN( 125)				_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("flixel/addons/ui/FlxUIState.hx",41,d4,72,a2),125,HX_("flixel.addons.ui.FlxUIState",7c,89,c0,87),HX_("create",fc,66,0f,7c)));
            			} catch( ::Dynamic _hx_e) {
...
HXLINE( 122)					if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE(   1)						::String msg = ( (::String)(_g1) );
HXLINE( 128)						{
HXLINE( 129)							::flixel::FlxG_obj::log->advanced(msg,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 130)							::haxe::Log_obj::trace(msg,::hx::SourceInfo(HX_("flixel/addons/ui/FlxUIState.hx",41,d4,72,a2),130,HX_("flixel.addons.ui.FlxUIState",7c,89,c0,87),HX_("create",fc,66,0f,7c)));
...
HXLINE( 145)			_hx_tmp2 = (this->_xml_id != HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 195)			_hx_tmp3 = ::hx::IsNotNull( this->_ui );
            		}
            		else {
