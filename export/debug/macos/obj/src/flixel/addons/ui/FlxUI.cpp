...
HXLINE( 782)								if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE(   1)									::String msg = ( (::String)(_g1) );
HXLINE( 787)									{
HXLINE( 788)										::flixel::FlxG_obj::log->advanced(msg,::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE( 789)										liveFile = null();
            									}
            								}
            								else {
HXLINE( 782)									HX_STACK_DO_THROW(_g);
            								}
            							}
            							else {
...
HXLINE( 868)							::flixel::FlxG_obj::log->advanced(((((HX_("Can't create FlxUI definition '",b5,82,49,00) + def_name) + HX_("', because '",92,6b,a1,0c)) + error) + HX_("' is a reserved name prefix!",16,78,51,ae)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            						}
            						else {
...
HXDLIN(   1)							 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE(1946)							if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE(   1)								::String msg = ( (::String)(_g1) );
HXLINE(1946)								::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            							}
            							else {
...
HXDLIN(   1)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE(4371)						if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE(   1)							::String msg = ( (::String)(_g1) );
HXLINE(4371)							::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
            						else {
...
HXDLIN(   1)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE(4456)						if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE(   1)							::String msg = ( (::String)(_g1) );
HXLINE(4456)							::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
            						else {
...
HXDLIN(   1)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE(4971)						if (::Std_obj::isOfType(_g1,::hx::ClassOf< ::String >())) {
HXLINE(   1)							::String msg = ( (::String)(_g1) );
HXLINE(4971)							::flixel::FlxG_obj::log->advanced((HX_("FlxUI: U.xml_gfx() : ",f9,3c,00,4f) + msg),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            						}
            						else {
