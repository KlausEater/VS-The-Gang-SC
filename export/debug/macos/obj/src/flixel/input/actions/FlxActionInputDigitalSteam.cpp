...
HX_DEFINE_STACK_FRAME(_hx_pos_90d9fb36f8ba61ec_269_new,"flixel.input.actions.FlxActionInputDigitalSteam","new",0xd8c8ba73,"flixel.input.actions.FlxActionInputDigitalSteam.new","flixel/input/actions/FlxActionInputDigital.hx",269,0x47a4ecd2)
...
void FlxActionInputDigitalSteam_obj::__construct(int ActionHandle,int Trigger, ::Dynamic __o_DeviceHandle){
            	...
            	HX_STACKFRAME(&_hx_pos_90d9fb36f8ba61ec_269_new)
HXLINE( 270)		super::__construct(::flixel::input::actions::FlxInputDevice_obj::STEAM_CONTROLLER_dyn(),ActionHandle,Trigger,DeviceHandle);
HXLINE( 274)		::flixel::FlxG_obj::log->advanced(HX_("steamwrap library not installed; steam inputs will be ignored.",eb,58,1d,c7),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            	}
