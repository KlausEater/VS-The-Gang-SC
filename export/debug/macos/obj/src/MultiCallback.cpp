...
HX_DEFINE_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_250_new,"MultiCallback","new",0x3682e930,"MultiCallback.new","LoadingState.hx",250,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_274_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",274,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_267_add,"MultiCallback","add",0x36790af1,"MultiCallback.add","LoadingState.hx",267,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_299_log,"MultiCallback","log",0x36816d54,"MultiCallback.log","LoadingState.hx",299,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_303_getFired,"MultiCallback","getFired",0x1ac970a8,"MultiCallback.getFired","LoadingState.hx",303,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_304_getUnfired,"MultiCallback","getUnfired",0xfdf08a2f,"MultiCallback.getUnfired","LoadingState.hx",304,0x53ff9bc9)

void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_250_new)
HXLINE( 258)		this->fired = ::Array_obj< ::String >::__new();
HXLINE( 257)		this->unfired =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXLINE( 255)		this->numRemaining = 0;
HXLINE( 254)		this->length = 0;
HXLINE( 253)		this->logId = null();
HXLINE( 262)		this->callback = callback;
HXLINE( 263)		this->logId = logId;
            	}
...
bool MultiCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic MultiCallback_obj::add(::String __o_id){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_274_add)
HXLINE( 274)			if (_gthis->unfired->exists(id)) {
HXLINE( 276)				_gthis->unfired->remove(id);
HXLINE( 277)				_gthis->fired->push(id);
HXLINE( 278)				_gthis->numRemaining--;
HXLINE( 280)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 281)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 281)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),300,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 283)				if ((_gthis->numRemaining == 0)) {
HXLINE( 285)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 286)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 286)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),300,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            						}
            					}
HXLINE( 287)					_gthis->callback();
            				}
            			}
            			else {
HXLINE( 291)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 291)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),300,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
            	...
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_267_add)
HXLINE( 266)		 ::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 268)		id = (((HX_("",00,00,00,00) + this->length) + HX_(":",3a,00,00,00)) + id);
HXLINE( 269)		this->length++;
HXLINE( 270)		this->numRemaining++;
HXLINE( 271)		 ::Dynamic func = null();
HXLINE( 272)		func =  ::Dynamic(new _hx_Closure_0(id,_gthis));
HXLINE( 293)		this->unfired->set(id,func);
HXLINE( 294)		return func;
            	}
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_299_log)
HXDLIN( 299)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 300)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),300,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_303_getFired)
HXDLIN( 303)		return this->fired->copy();
            	}
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_304_getUnfired)
HXDLIN( 304)		::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 304)		{
HXDLIN( 304)			 ::Dynamic id = this->unfired->keys();
HXDLIN( 304)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 304)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 304)				_g->push(id1);
            			}
            		}
HXDLIN( 304)		return _g;
            	}
