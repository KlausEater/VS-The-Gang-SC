...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_95_voicesHIFI,"Paths","voicesHIFI",0x5c8352e5,"Paths.voicesHIFI","Paths.hx",95,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_100_voicesLOFI,"Paths","voicesLOFI",0x5f2cbae7,"Paths.voicesLOFI","Paths.hx",100,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_105_inst,"Paths","inst",0x9186a526,"Paths.inst","Paths.hx",105,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_110_instHIFI,"Paths","instHIFI",0xfb462eaa,"Paths.instHIFI","Paths.hx",110,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_115_instLOFI,"Paths","instLOFI",0xfdef96ac,"Paths.instLOFI","Paths.hx",115,0x309ea470)
...
::String Paths_obj::voicesHIFI(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_95_voicesHIFI)
HXDLIN(  95)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Voices_HIFI.",7b,80,3f,17)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,voicesHIFI,return )

::String Paths_obj::voicesLOFI(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_100_voicesLOFI)
HXDLIN( 100)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Voices_LOFI.",39,1a,d1,68)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,voicesLOFI,return )
...
::String Paths_obj::instHIFI(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_110_instHIFI)
HXDLIN( 110)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Inst_HIFI.",c0,0d,67,4c)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,instHIFI,return )

::String Paths_obj::instLOFI(::String song){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_115_instLOFI)
HXDLIN( 115)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + song.toLowerCase()) + HX_("/Inst_LOFI.",7e,a7,f8,9d)) + HX_("ogg",4f,94,54,00));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Paths_obj,instLOFI,return )
...
bool Paths_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"instHIFI") ) { outValue = instHIFI_dyn(); return true; }
		if (HX_FIELD_EQ(inName,"instLOFI") ) { outValue = instLOFI_dyn(); return true; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"voicesHIFI") ) { outValue = voicesHIFI_dyn(); return true; }
		if (HX_FIELD_EQ(inName,"voicesLOFI") ) { outValue = voicesLOFI_dyn(); return true; }
		break;
	case 11:
...
static ::String Paths_obj_sStaticFields[] = {
	...
	HX_("voicesHIFI",85,a9,6c,6c),
	HX_("voicesLOFI",87,11,16,6f),
	HX_("inst",c6,43,bb,45),
	HX_("instHIFI",4a,9d,3e,49),
	HX_("instLOFI",4c,05,e8,4b),
