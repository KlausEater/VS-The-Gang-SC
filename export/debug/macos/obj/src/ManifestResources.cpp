...
#include <Reflect.h>
#endif
#ifndef INCLUDED___ASSET__OPENFL__assets_fonts_fridaynightfunkin_regular_ttf
#include <__ASSET__OPENFL__assets_fonts_fridaynightfunkin_regular_ttf.h>
#endif
...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_fridaynightfunkin_regular_ttf >());
...
HXLINE(  74)		{
HXLINE(  74)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  74)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v);
            		}
HXLINE(  75)		{
HXLINE(  75)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN(  75)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v1);
            		}
HXLINE(  76)		{
HXLINE(  76)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/tutorial.json",58,c3,5d,36));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("tutorial",9e,8f,b5,82),v2);
            		}
HXLINE(  77)		{
HXLINE(  77)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/week1.json",19,f4,32,f2));
HXDLIN(  77)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week1",bd,95,be,c7),v3);
            		}
HXLINE(  78)		{
HXLINE(  78)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/week2.json",78,50,8e,58));
HXDLIN(  78)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week2",be,95,be,c7),v4);
            		}
HXLINE(  79)		{
HXLINE(  79)			::String v5 = (::ManifestResources_obj::rootPath + HX_("manifest/week3.json",d7,ac,e9,be));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week3",bf,95,be,c7),v5);
            		}
HXLINE(  80)		{
HXLINE(  80)			::String v6 = (::ManifestResources_obj::rootPath + HX_("manifest/week4.json",36,09,45,25));
HXDLIN(  80)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week4",c0,95,be,c7),v6);
            		}
HXLINE(  81)		{
HXLINE(  81)			::String v7 = (::ManifestResources_obj::rootPath + HX_("manifest/week5.json",95,65,a0,8b));
HXDLIN(  81)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week5",c1,95,be,c7),v7);
            		}
HXLINE(  82)		{
HXLINE(  82)			::String v8 = (::ManifestResources_obj::rootPath + HX_("manifest/week6.json",f4,c1,fb,f1));
HXDLIN(  82)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week6",c2,95,be,c7),v8);
            		}
HXLINE(  83)		{
HXLINE(  83)			::String v9 = (::ManifestResources_obj::rootPath + HX_("manifest/week7.json",53,1e,57,58));
HXDLIN(  83)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week7",c3,95,be,c7),v9);
            		}
HXLINE(  84)		{
HXLINE(  84)			::String v10 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  84)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v10);
            		}
HXLINE(  61)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
...
HXLINE(  93)		library = ::lime::utils::Assets_obj::getLibrary(HX_("tutorial",9e,8f,b5,82));
HXLINE(  94)		if (::hx::IsNotNull( library )) {
HXLINE(  94)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  95)			::ManifestResources_obj::preloadLibraryNames->push(HX_("tutorial",9e,8f,b5,82));
            		}
HXLINE(  96)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week1",bd,95,be,c7));
HXLINE(  97)		if (::hx::IsNotNull( library )) {
HXLINE(  97)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  98)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week1",bd,95,be,c7));
            		}
HXLINE(  99)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week2",be,95,be,c7));
HXLINE( 100)		if (::hx::IsNotNull( library )) {
HXLINE( 100)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 101)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week2",be,95,be,c7));
            		}
HXLINE( 102)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week3",bf,95,be,c7));
HXLINE( 103)		if (::hx::IsNotNull( library )) {
HXLINE( 103)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 104)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week3",bf,95,be,c7));
            		}
HXLINE( 105)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week4",c0,95,be,c7));
HXLINE( 106)		if (::hx::IsNotNull( library )) {
HXLINE( 106)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 107)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week4",c0,95,be,c7));
            		}
HXLINE( 108)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week5",c1,95,be,c7));
HXLINE( 109)		if (::hx::IsNotNull( library )) {
HXLINE( 109)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 110)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week5",c1,95,be,c7));
            		}
HXLINE( 111)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE( 112)		if (::hx::IsNotNull( library )) {
HXLINE( 112)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 113)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
HXLINE( 114)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week7",c3,95,be,c7));
HXLINE( 115)		if (::hx::IsNotNull( library )) {
HXLINE( 115)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 116)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week7",c3,95,be,c7));
            		}
HXLINE( 117)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 118)		if (::hx::IsNotNull( library )) {
HXLINE( 118)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 119)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
