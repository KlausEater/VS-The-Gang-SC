...
static const ::String _hx_array_data_c96d938b_6[] = {
	HX_("NOOB",94,db,ca,33),HX_("EASY",02,54,cd,2d),HX_("NORMAL",27,1e,ec,e2),HX_("HARD",eb,f6,c8,2f),HX_("EXPERT",ea,a6,f8,76),HX_("INSANE",aa,e2,5c,50),
};
...
HXDLIN(   9)		difficultyArray = ::Array_obj< ::String >::fromData( _hx_array_data_c96d938b_6,6);
            	}
}
