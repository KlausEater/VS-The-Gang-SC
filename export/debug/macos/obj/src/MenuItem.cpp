...
HX_DEFINE_STACK_FRAME(_hx_pos_a2a86a23843e0eb5_11_new,"MenuItem","new",0x11397064,"MenuItem.new","MenuItem.hx",11,0x14bda78c)
HX_LOCAL_STACK_FRAME(_hx_pos_a2a86a23843e0eb5_28_startFlashing,"MenuItem","startFlashing",0xa64b34b8,"MenuItem.startFlashing","MenuItem.hx",28,0x14bda78c)
HX_LOCAL_STACK_FRAME(_hx_pos_a2a86a23843e0eb5_38_update,"MenuItem","update",0x1808c085,"MenuItem.update","MenuItem.hx",38,0x14bda78c)

void MenuItem_obj::__construct(Float x,Float y,::hx::Null< int >  __o_weekNum){
            		int weekNum = __o_weekNum.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_a2a86a23843e0eb5_11_new)
HXLINE(  35)		this->fakeFramerate = ::Math_obj::round(((( (Float)(1) ) / ::flixel::FlxG_obj::elapsed) / ( (Float)(10) )));
HXLINE(  24)		this->isFlashing = false;
HXLINE(  15)		this->flashingInt = 0;
HXLINE(  13)		this->targetY = ((Float)0);
...
HXDLIN(  20)		this->week = _hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (HX_("storymenu/week",0f,e3,c9,3d) + weekNum)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE(  21)		this->add(this->week);
            	}
...
void MenuItem_obj::startFlashing(){
            	HX_STACKFRAME(&_hx_pos_a2a86a23843e0eb5_28_startFlashing)
HXDLIN(  28)		this->isFlashing = true;
            	}
...
void MenuItem_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_a2a86a23843e0eb5_38_update)
HXLINE(  39)		this->super::update(elapsed);
HXLINE(  40)		Float a = this->y;
HXDLIN(  40)		this->set_y((a + ((((Float)0.17) / (( (Float)(::MainVariables_obj::_variables->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ) / ( (Float)(60) ))) * (((this->targetY * ( (Float)(120) )) + 480) - a))));
HXLINE(  42)		if (this->isFlashing) {
HXLINE(  43)			 ::MenuItem _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  43)			_hx_tmp->flashingInt = (_hx_tmp->flashingInt + 1);
            		}
HXLINE(  45)		if ((::hx::Mod(this->flashingInt,this->fakeFramerate) >= ::Math_obj::floor((( (Float)(this->fakeFramerate) ) / ( (Float)(2) ))))) {
HXLINE(  46)			this->week->set_color(-13369345);
            		}
            		else {
HXLINE(  48)			this->week->set_color(11611903);
            		}
            	}
