...
class HXCPP_CLASS_ATTRIBUTES Note_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		static int RED_NOTE;
		static bool canMissLeft;
		static bool canMissRight;
		static bool canMissUp;
		static bool canMissDown;
		static void setCanMiss(int data,bool _hx_bool);
		static ::Dynamic setCanMiss_dyn();
