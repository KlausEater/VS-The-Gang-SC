...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		static  ::openfl::display::Sprite watermark;
		static void main();
		static ::Dynamic main_dyn();

		static  ::openfl::display::FPS fpsCounter;
		static void toggleFPS(bool fpsEnabled);
		static ::Dynamic toggleFPS_dyn();

		static  ::MemoryCounter memoryCounter;
		static void toggleMem(bool memEnabled);
		static ::Dynamic toggleMem_dyn();
