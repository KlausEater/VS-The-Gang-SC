...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String voicesHIFI(::String song);
		static ::Dynamic voicesHIFI_dyn();

		static ::String voicesLOFI(::String song);
		static ::Dynamic voicesLOFI_dyn();

		static ::String inst(::String song);
		static ::Dynamic inst_dyn();

		static ::String instHIFI(::String song);
		static ::Dynamic instHIFI_dyn();

		static ::String instLOFI(::String song);
		static ::Dynamic instLOFI_dyn();
