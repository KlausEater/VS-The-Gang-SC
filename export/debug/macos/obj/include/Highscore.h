...
class HXCPP_CLASS_ATTRIBUTES Highscore_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::haxe::ds::StringMap endlessScores;
		static  ::haxe::ds::StringMap songRanks;
		static void saveScore(::String song,::hx::Null< int >  score, ::Dynamic diff);
		static ::Dynamic saveScore_dyn();

		static void saveRank(::String song,::hx::Null< int >  score, ::Dynamic diff);
		static ::Dynamic saveRank_dyn();

		static void saveWeekScore(::hx::Null< int >  week,::hx::Null< int >  score, ::Dynamic diff);
		static ::Dynamic saveWeekScore_dyn();

		static void saveMarathonScore(::hx::Null< int >  score);
		static ::Dynamic saveMarathonScore_dyn();

		static void saveEndlessScore(::String song,::hx::Null< int >  score);
		static ::Dynamic saveEndlessScore_dyn();

		static void setScore(::String song,int score);
		static ::Dynamic setScore_dyn();

		static void setEndless(::String song,int score);
		static ::Dynamic setEndless_dyn();

		static void setRank(::String song,int score);
		static ::Dynamic setRank_dyn();
		...
		static int getEndless(::String song);
		static ::Dynamic getEndless_dyn();

		static int getRank(::String song,int diff);
		static ::Dynamic getRank_dyn();
