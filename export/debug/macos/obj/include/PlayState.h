...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static ::Array< ::String > dialogue;
		static int misses;
		static Float accuracy;
		static int arrowLane;
		static bool ended;
		...
		int curSection;
		 ...
		 ::flixel::group::FlxTypedGroup player2Strums;
		::Array< ::Dynamic> strums2;
		 ::flixel::group::FlxTypedGroup hearts;
		bool camZooming;
		::String curSong;
		int gfSpeed;
		Float health;
		...
		bool isHalloween;
		 ...
		 ::flixel::FlxSprite LightsOutBG;
		 ::flixel::FlxSprite BlindingBG;
		 ::flixel::FlxSprite freezeIndicator;
		bool triggeredAlready;
		bool allowedToHeadbang;
		bool talking;
		int songScore;
		 ::flixel::text::FlxText scoreTxt;
		 ::flixel::text::FlxText missTxt;
		Float totalNotesHit;
		int totalPlayed;
		 ::flixel::text::FlxText accuracyTxt;
		bool canDie;
		int nps;
		 ::flixel::text::FlxText npsTxt;
		Float lives;
		 ::flixel::FlxSprite heartSprite;
		Float offbeatValue;
		Float speedNote;
		Float noteDrunk;
		Float noteAccel;
		...
		::String dialogueSuffix;
		Float miscLerp;
		Float camLerp;
		Float zoomLerp;
		void create();

		void dialogueOrCountdown();
		::Dynamic dialogueOrCountdown_dyn();

		void modifierValues();
		::Dynamic modifierValues_dyn();
		...
		void sustain2(int strum, ::Note note);
