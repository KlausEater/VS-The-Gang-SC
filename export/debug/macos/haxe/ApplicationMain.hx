...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Funkin MU", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Funkin MU", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "Verwex";
		app.meta["file"] = "Funkin MU";
		app.meta["name"] = "Friday Night Funkin': Mic'd Up";
		app.meta["packageName"] = "com.verwex.funkMU";
		app.meta["version"] = "MU 2.0.2";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Friday Night Funkin': Mic'd Up",
			width: 1280,
			x: null,
			y: null,
		};
